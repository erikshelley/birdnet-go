...
| POST   | `/integrations/birdweather/test`             | `TestBirdWeatherConnection`     | ✅   | Test BirdWeather connection (upload stages, plus a "Station Read Access" stage when the request's `download.enabled` is true) |
